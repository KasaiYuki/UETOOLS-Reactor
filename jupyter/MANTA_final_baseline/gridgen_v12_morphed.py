...
def setGrid(steps=4, plot=True):
    ...
    com.geqdskfname[0] = 'FDC24_TokaMaker_2024-11-06_v12_AL_FS.geqdsk'
    com.aeqdskfname[0] = 'aeqdsk_v12_morphed'
    ...
    if steps>1:
        ...
        grd.slpxt = 2.4 # Cell compression factor at plates: higher values, more compressed
        ...
        write_gridue("reconverged_v12_diag_p20_imp_integrated.hdf5") # Write HDF5 gridue
        c.reload() # Update Case arrays to reflect zshift
        if plot:
            f = c.plot.gridue('reconverged_v12_diag_p20_imp_integrated.hdf5', plates=False)
