...
def rundt(  dtreal,nfe_tot=0,savedir='../solutions',dt_tot=0,ii1max=100,ii2max=5,ftol_dt=1e-5,itermx=10,rlx=0.9,n_stor=0,
            tstor=(1e-3,4e-2),incpset=5,dtmfnk3=1e-4):
