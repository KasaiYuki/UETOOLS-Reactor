...
plate1 = loadtxt("plate1_vert",delimiter=",")
...
#plate2 = loadtxt("plate2_modslant",delimiter=",")
plate2 = loadtxt("plate2_bigslant",delimiter=",")
#plate2 = loadtxt("plate2_hugeslant",delimiter=",")
