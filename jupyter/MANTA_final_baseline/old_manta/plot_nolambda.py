...
def plotvarMANTA(var, title='', label=None, iso=True, rzlabels=True, stats=True, message=None,
...
#    plt.title(r'$q_\parallel$ at divertor entrance ($P_{xpt\ in}:P_{xpt\ out}$ = 1:%.1f)' % (intqo/intqi))
    plt.plot(xq*1000, qparo/1e9, c=c0)
